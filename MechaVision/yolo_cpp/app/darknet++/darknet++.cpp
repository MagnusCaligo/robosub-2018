...
int main(int argc, char** argv)
{
	...
	Yolo yolo;
	std::cout << "Test1";
	yolo.setConfigFilePath("/home/ubuntu/yolo_cpp/app/DetectTrackDistance/cfg/yolo.cfg");
	yolo.setDataFilePath("/home/ubuntu/yolo_cpp/app/DetectTrackDistance/cfg/coco.data");
	yolo.setWeightFilePath("/home/ubuntu/yolo_cpp/app/DetectTrackDistance/data/yolo.weights");
	std::cout << "Test3";
	yolo.setAlphabetPath("/home/ubuntu/yolo_cpp/app/DetectTrackDistance/data/labels/");
	std::cout << "Test4";
	yolo.setNameListFile("/home/ubuntu/yolo_cpp/app/DetectTrackDistance/data/coco.names");
	std::cout << "Test2";
