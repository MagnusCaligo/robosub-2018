...
class ExternalComm(QtCore.QObject):
    ...
    def __init__(self, mainWindow):
        ...
        self.externalCommThread = ExternalCommThread(self)
...
class ExternalCommThread(QtCore.QThread):
    ...
    def __initSensors__(self):
        ...
        # DVL initialization
        try:
            DVLComPort = serial.Serial("/dev/ttyUSB4", 115200)
            ...
            dvlAhrsComPort = serial.Serial("/dev/ttyUSB5", 38400)
        ...
        try:
            ...
            self.spartonResponseThread1 = sparton_ahrs.SpartonAhrsResponse("COM12")
        ...
        try:    
            self.spartonResponseThread2 = sparton_ahrs.SpartonAhrsResponse("/dev/ttyUSB5")
    ...
    def cleanStop(self):
        ...
        if self.dvlResponseThread != None:
        	self.dvlResponseThread.kill()
        	self.dvlAhrsDummyThread.kill()
...
>>>>>>> Stashed changes
	...
	if self.isDebug:       
		pass#print self.orientation, self.position
