...
class Buoys(AbstractMission):
    ...
    def calculateSpecificWaypoint(self, externalComm, movementController):
        ...
        if len(detections) > 0:
            ...
            if tvec[1] > .5:
                ...
                goToDepth = -.5
            pose, n,e,u,x,y,z = movementController.relativeMove(externalComm.orientation+externalComm.position, None,None,None,None,None,None, tvec[0], tvec[1], tvec[2]- int(self.parameters["getDistanceAway"]), 0,0,0)
    ...
    def getExecutionPositionDifference(self, externalComm, movementController):
        ...
        if self.relativeMoveWaypoint != None:
        	movementController.advancedMove(externalComm.orientation + externalComm.position, self.relativeMoveWaypoint[0], self.relativeMoveWaypoint[1], self.relativeMoveWaypoint[2],
