...
class TorpedoBoard(AbstractMission):
	...
	def lookForObstacles(self, externalComm, movementController):
		...
		if self.relativeMoveWaypoint == None:
			pos, n, e, u, x, y, z = movementController.relativeMove(externalComm.orientation + externalComm.position, 0,0,self.depthOfObstacle - externalComm.position[2],0,self.angle,0)
