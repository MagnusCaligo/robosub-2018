...
class ControlSystemWidget(QtCore.QObject):
    ...
    def listData(currentPosition, desiredPosition):
        currentTabIndex = self.ui_controlSystemsWidget.tabWidget.currentIndex
        mapToDegree = { 0:3, 1:-1, 2:4, 3:5, 4:2, 5:0, 6:1}
        ...
        self.graph.updateValues(currentPosition[selectedPID], desiredPosition[selectedPID])
