...
class Ui_MissionCommander(object):
    ...
    def retranslateUi(self, MissionCommander):
        ...
        self.missionTypeCB.setItemText(2, _translate("MissionCommander", "Navigation v3", None))
        self.missionTypeCB.setItemText(3, _translate("MissionCommander", "Qualification Gate", None))
        self.missionTypeCB.setItemText(4, _translate("MissionCommander", "Bouys - Red", None))
        self.missionTypeCB.setItemText(5, _translate("MissionCommander", "Bouys - Green", None))
        self.missionTypeCB.setItemText(6, _translate("MissionCommander", "Bouys - Yellow", None))
        self.missionTypeCB.setItemText(7, _translate("MissionCommander", "Football Gate", None))
        self.missionTypeCB.setItemText(8, _translate("MissionCommander", "Torpedo Board - Locate", None))
        self.missionTypeCB.setItemText(9, _translate("MissionCommander", "Torpedo Board - Grab Handle", None))
        self.missionTypeCB.setItemText(10, _translate("MissionCommander", "Torpedo Board - Fire Torpedos", None))
        self.missionTypeCB.setItemText(11, _translate("MissionCommander", "Dropper - Locate", None))
        self.missionTypeCB.setItemText(12, _translate("MissionCommander", "Dropper - Grab Handle", None))
        self.missionTypeCB.setItemText(13, _translate("MissionCommander", "Dropper - Drop", None))
        self.missionTypeCB.setItemText(14, _translate("MissionCommander", "Octogon", None))
        self.missionTypeCB.setItemText(15, _translate("MissionCommander", "Entry Gate v3", None))
